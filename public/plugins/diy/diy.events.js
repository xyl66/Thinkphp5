$(function() {
    ...
    HYD.DIY.Unit.event_type4 = function(ctrldom, data) {
        ...
        //改变样式
        $ctrl.find("input[name='layoutstyles']").change(function() {
            var val = $(this).val();
            data.content.layoutstyles = val; //同步数据到缓存
            reRender(setImgHeightcallback);
        });
        ...
        //是否显示商品价格
        $ctrl.find("input[name='priceBold']").change(function() {
            var val = $(this).val();
            data.content.priceBold = val; //同步数据到缓存
            reRender(setImgHeightcallback);
        });
    ...
    HYD.DIY.Unit.event_type8 = function(ctrldom, data) {
        ...
        //改变布局\样式
        $ctrl.find("input[name='layout'],input[name='layout1_style'],input[name='hasImgMargin']").change(function() {
