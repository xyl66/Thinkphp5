$(function() {
    ...
    HYD.DIY.bindEvents = function(ctrldom, data) {
        ...
        //     case 4:HYD.DIY.Unit.event_type4(ctrldom, data);break;//产品
        //     case 5:HYD.DIY.Unit.event_type5(ctrldom, data);break;//产品列表（分组标签）
        //     // case 6:HYD.DIY.Unit.event_type6(ctrldom, data);break;//产品搜索
